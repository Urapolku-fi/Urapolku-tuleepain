document.addEventListener("DOMContentLoaded", () => {
    ...
    if (window.location.hash === '#sign-up') {
        openSignUp(signupButton, signupDropdown, main);
    } else {
        closeSignUp(signupButton, signupDropdown, main);
    }
...
function openSignUp(signupButton, signupDropdown, main) {
...
function closeSignUp(signupButton, signupDropdown, main) {
